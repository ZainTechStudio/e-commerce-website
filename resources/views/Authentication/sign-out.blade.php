          ...
          <div class="col-sm-10 col-md-8 col-lg-5 col-xl-4 col-xxl-3">
            <div class="text-center mb-6 mx-auto"><img class="mb-7 d-dark-none" src="../../../assets/img/spot-illustrations/1.png" alt="phoenix" /><img class="mb-7 d-light-none" src="../../../assets/img/spot-illustrations/dark_1.png" alt="phoenix" />
              <div class="mb-6">
                ...
                <p class="text-body-tertiary">Thanks for for visiting site. <br class="d-lg-none" />You are now successfully signed out.</p>
              </div>
              <div class="d-grid"><a class="btn btn-primary" href="{{ route('sign-in_page') }}"><span class="fas fa-angle-left me-2"></span>Go to sign in page</a></div>
            </div>
          </div>
        </div>
      </div>

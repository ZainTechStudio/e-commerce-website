          ...
          <div class="col-sm-10 col-md-8 col-lg-5 col-xxl-4"><a class="d-flex flex-center text-decoration-none mb-4" href="../../../index.html">
            ...
            <div class="px-xxl-5">
              <div class="text-center mb-6">
                ...
                <form method="POST" action="{{route('forgot-password')}}" class="d-flex align-items-center mb-2">@csrf<input class="form-control flex-1" id="email" type="email" name="email" placeholder="Enter your email address" />

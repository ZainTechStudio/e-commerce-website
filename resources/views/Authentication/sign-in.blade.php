...
<html lang="en-US" dir="ltr" data-navigation-type="default" data-navbar-horizontal-shape="default">
  ...
  <head>
    ...
    <!--    Favicons-->
    <!-- ===============================================-->
    <link rel="apple-touch-icon" sizes="180x180" href="../../../assets/img/favicons/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="32x32" href="../../../assets/img/favicons/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="16x16" href="../../../assets/img/favicons/favicon-16x16.png">
    <link rel="shortcut icon" type="image/x-icon" href="../../../assets/img/favicons/favicon-32x32.png">
    <link rel="preload" as="image" href="/assets/img/favicons/favicon-32x32.png">
    ...
    <main class="main" id="top">
      <div class="container">
        ...
        <div class="alert alert-outline-success d-flex align-items-center mt-3" role="alert">
          <span class="fas fa-times-circle text-success fs-5 me-3"></span>
        ...
        <div class="row flex-center min-vh-100 py-5">
          <div class="col-sm-10 col-md-8 col-lg-5 col-xl-5 col-xxl-3"><a class="d-flex flex-center text-decoration-none mb-4" href="../../../index.html">
            ...
            <div class="position-relative">
              ...
              <div class="divider-content-center">sign-in</div>
            </div>
            <form method="POST" action="{{ route('sign-in') }}">
              @csrf
              <div class="mb-3 text-start"><label class="form-label" for="email">Email address</label>
                <div class="form-icon-container"><input value="@if(isset($old['email'])){{ $old['email'] }}@else{{ old('email') }}@endif" class="form-control form-icon-input" name="email" id="email" type="email" placeholder="name@example.com" /><span class="fas fa-user text-body fs-9 form-icon"></span></div>
                  <span class="text-danger">
                    @if (isset($emailErr))
                    <span class="text-danger me-2" data-feather="alert-circle" style="height: 1rem; width: 1rem;"></span>
                    {{ $emailErr }}
                    @else
                    @error('email')
                    <span class="text-danger me-2" data-feather="alert-circle" style="height: 1rem; width: 1rem;"></span>
                ...
                <div class="mb-3 text-start"><label class="form-label" for="password">Password</label>
                  <div class="form-icon-container" data-password="data-password"><input value="@if(isset($old['password'])){{ $old['password'] }}@else{{ old('password') }}@endif" class="form-control form-icon-input pe-6" name="password" id="password" type="password" placeholder="Password" data-password-input="data-password-input" /><span class="fas fa-key text-body fs-9 form-icon"></span><button type="button" class="btn px-3 py-0 h-100 position-absolute top-0 end-0 fs-7 text-body-tertiary" data-password-toggle="data-password-toggle"><span class="uil uil-eye show"></span><span class="uil uil-eye-slash hide"></span></button></div>
                  <span class="text-danger">
                    @if (isset($passErr))
                    <span class="text-danger me-2" data-feather="alert-circle" style="height: 1rem; width: 1rem;"></span>
                    {{ $passErr }}
              ...
              <div class="row flex-between-center mb-7">
                ...
                <div class="col-auto"><a class="fs-9 fw-semibold" href="{{ route('forgot-password_page') }}">Forgot Password?</a></div>
              </div><button type="submit" class="btn btn-primary w-100 mb-3">Sign In</button>
            </form>
            <div class="text-center"><a class="fs-9 fw-bold" href="{{ route('sign-up_page') }}">Create an account</a></div>
          </div>
        </div>
      </div>

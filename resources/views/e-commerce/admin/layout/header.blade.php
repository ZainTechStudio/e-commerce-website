...
@stack('title')
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('/assets/img/favicons/favicon-16x16.png')}}">
...
@stack('style')
    ...
    <script>
      ...
      function navitemsactiveness(id) {
        let navitems = document.querySelectorAll(`.nav-active-link`)
        navitems.forEach(element => {
          element.classList.remove('active')
        });
        let getactiveelement = document.querySelectorAll(`#${id}`);
        getactiveelement.forEach(element => {
          element.classList.add('active');
        });
      }
      function navitemvisibility(id) {
        let allparentnavitems = document.querySelectorAll(`.nav-visibility`)
        allparentnavitems.forEach(element => {
    ...
    <main class="main" id="top">
          ...
          <div class="navbar-vertical-content">
            <ul class="navbar-nav flex-column" id="navbarVerticalNav">
              <li class="nav-item">
                ...
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-home" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="nv-home">
                    <div class="d-flex align-items-center">
                      <div class="dropdown-indicator-icon-wrapper"><span class="fas fa-caret-right dropdown-indicator-icon"></span></div><span class="nav-link-icon"><span data-feather="home"></span></span><span class="nav-link-text">Home</span>
                    </div>
                  </a>
                  <div class="parent-wrapper label-1">
                    <ul class="nav collapse parent nav-visibility" data-bs-parent="#navbarVerticalCollapse" id="nv-home">
                      <li class="collapsed-nav-item-title d-none">Home</li>
                      <li class="nav-item"><a id="dashboard" class="nav-link nav-active-link" href="{{ route('dashboard')}}">
              ...
              <li class="nav-item">
                ...
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-store" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-store">
                    <div class="d-flex align-items-center">
                  ...
                  <div class="parent-wrapper label-1">
                    <ul class="nav collapse parent nav-visibility" data-bs-parent="#navbarVerticalCollapse" id="nv-store">
                      ...
                      <li class="nav-item"><a id="customer" class="nav-link nav-active-link" href="{{ route('customer') }}">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Customers</span></div>
                        </a><!-- more inner pages-->
                      </li>
                      <li class="nav-item"><a id="customer-details" class="nav-link nav-active-link" href="{{ route('customer-details') }}">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Customer details</span></div>
                        </a><!-- more inner pages-->
                      </li>
                      <li class="nav-item"><a id="order" class="nav-link nav-active-link" href="{{ route('order') }}">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Orders</span></div>
                        </a><!-- more inner pages-->
                      </li>
                      <li class="nav-item"><a id="order-details" class="nav-link nav-active-link" href="{{ route('order-details') }}">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Order details</span></div>
                        </a><!-- more inner pages-->
                      </li>
                      <li class="nav-item"><a id="refund" class="nav-link nav-active-link" href="{{ route('refund') }}">
              ...
              <li class="nav-item">
                ...
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-settings" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="nv-settings">
                  ...
                  <div class="parent-wrapper label-1">
                    <ul class="nav collapse parent nav-visibility" data-bs-parent="#navbarVerticalCollapse" id="nv-settings">
                      <li class="collapsed-nav-item-title d-none">Settings</li>
                      <li class="nav-item"><a id="add-new-category" class="nav-link nav-active-link" href="{{ route('add-new-category')}}">
                          <div class="d-flex align-items-center"><span class="nav-link-text">add-new-attributes</span></div>
                        </a>
                      </li>
                    </ul>
                  </div>
        ...
        <div class="collapse navbar-collapse justify-content-between">
          <div class="navbar-logo">
            ...
            <a class="navbar-brand me-1 me-sm-3" href="{{ route('dashboard')}}">
              <div class="d-flex align-items-center">
                <div class="d-flex align-items-center"><img src="{{ asset('/assets/img/icons/logo.png')}}" alt="Jewellery Artistic" width="27" />
                  <h5 class="logo-text ms-2 d-none d-sm-block">Jewellery Artistic</h5>
                </div>
              </div>
            </a>
          </div>
              ...
              <div class="dropdown-menu dropdown-menu-end navbar-dropdown-caret py-0 dropdown-profile shadow border" aria-labelledby="navbarDropdownUser">
                <div class="card position-relative border-0">
                  ...
                  <div class="card-footer p-0 border-top border-translucent">
                    ...
                    <hr />
                    <div class="px-3"> <a class="btn btn-phoenix-secondary d-flex flex-center w-100" href="{{route('sign-out_page')}}"> <span class="me-2" data-feather="log-out"> </span>Sign out</a></div>
      ...
      <nav class="navbar navbar-top navbar-slim fixed-top navbar-expand" id="topNavSlim" style="display:none;">
        <div class="collapse navbar-collapse justify-content-between">
          <div class="navbar-logo">
            <button class="btn navbar-toggler navbar-toggler-humburger-icon hover-bg-transparent" type="button" data-bs-toggle="collapse" data-bs-target="#navbarVerticalCollapse" aria-controls="navbarVerticalCollapse" aria-expanded="false" aria-label="Toggle Navigation"><span class="navbar-toggle-icon"><span class="toggle-line"></span></span></button>
            <a class="navbar-brand navbar-brand" href="{{ route('dashboard')}}">Jewellery Artistic <span class="text-body-highlight d-none d-sm-inline">slim</span></a>
          </div>
          <ul class="navbar-nav navbar-nav-icons flex-row">
            <li class="nav-item">
      ...
      <nav class="navbar navbar-top fixed-top navbar-expand-lg" id="navbarTop" style="display:none;">
        ...
        <div class="collapse navbar-collapse navbar-top-collapse order-1 order-lg-0 justify-content-center" id="navbarTopCollapse">
          <ul class="navbar-nav navbar-nav-top" data-dropdown-on-hover="data-dropdown-on-hover">
            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle lh-1" href="#!" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false"><span data-feather="home"></span>&nbsp;&nbsp;Home</a>
              <ul class="dropdown-menu navbar-dropdown-caret">
                <li><a class="dropdown-item nav-active-link" id="dashboard" href="{{ route('dashboard')}}">
                    <div class="dropdown-item-wrapper">Dashboard</div>
                  </a></li>
              </ul>
            </li>
            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle lh-1" href="#!" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false"><span data-feather="shopping-cart"></span>&nbsp;&nbsp;Store</a>
              <ul class="dropdown-menu navbar-dropdown-caret">
                ...
                <li><a class="dropdown-item nav-active-link" id="customer" href="{{ route('customer') }}">
                    <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Customers</div>
                  </a></li>
                <li><a class="dropdown-item nav-active-link" id="customer-details" href="{{ route('customer-details') }}">
                    <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Customer details</div>
                  </a></li>
                <li><a class="dropdown-item nav-active-link" id="order" href="{{ route('order') }}">
                    <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Orders</div>
                  </a></li>
                <li><a class="dropdown-item nav-active-link" id="order-details" href="{{ route('order-details') }}">
                    <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Order details</div>
                  </a></li>
                <li><a class="dropdown-item nav-active-link" id="refund" href="{{ route('refund') }}">
                    <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Refund</div>
                  </a></li>
              </ul>
            </li>
            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle lh-1" href="#!" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false"><span data-feather="settings"></span>&nbsp;&nbsp;Settings</a>
              <ul class="dropdown-menu navbar-dropdown-caret">
                <li><a class="dropdown-item nav-active-link" id="add-new-category" href="{{ route('add-new-category')}}">
                    <div class="dropdown-item-wrapper">add-new-attributes</div>
                  </a></li>
              </ul>
            </li>
          </ul>

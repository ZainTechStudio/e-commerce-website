          ...
          <div class="ecommerce-topbar">
            <nav class="navbar navbar-expand-lg navbar-light px-0">
              <div class="row gx-0 gy-2 w-100 flex-between-center">
                <div class="col-auto"><a class="text-decoration-none" href="{{ url('landing/index') }}">
                    <div class="d-flex align-items-center"><img src="../../../assets/img/icons/logo.png" alt="phoenix" width="27" />
                      <h5 class="logo-text ms-2">Jewellery Artistic</h5>
                    </div>
                  </a></div>
                <div class="col-auto order-md-1">
                  <ul class="navbar-nav navbar-nav-icons flex-row me-n2">
                    ...
                    <li class="nav-item"><a class="nav-link px-2 icon-indicator icon-indicator-primary" href="{{ url('landing/cart') }}" role="button"><span class="text-body-tertiary" data-feather="shopping-cart" style="height:20px;width:20px;"></span><span class="icon-indicator-number">3</span></a></li>
                      ...
                      <div class="dropdown-menu dropdown-menu-end notification-dropdown-menu py-0 shadow border navbar-dropdown-caret mt-2" id="navbarDropdownNotfication" aria-labelledby="navbarDropdownNotfication">
                        <div class="card position-relative border-0">
                          ...
                          <div class="card-footer p-0 border-top border-translucent border-0">
                            <div class="my-2 text-center fw-bold fs-10 text-body-tertiary text-opactity-85"><a class="fw-bolder" href="../../../pages/notifications') }}">Notification history</a></div>
                          </div>
                        </div>
                      </div>
                    </li>
      ...
      <nav class="navbar-responsive-navitems navbar-expand navbar-light bg-body-emphasis justify-content-between">
        <div class="container-small d-flex flex-between-center" data-navbar="data-navbar">
          ...
          <ul class="navbar-nav justify-content-end align-items-center">
            <li class="nav-item" data-nav-item="data-nav-item"><a id="home" class="nav-link ps-0" href="{{ url('/landing/index') }}">Home</a></li>
            <li class="nav-item" data-nav-item="data-nav-item"><a id="fav" class="nav-link" href="{{ url('/landing/fav') }}">My Favourite Stores</a></li>
            <li class="nav-item" data-nav-item="data-nav-item"><a id="product" class="nav-link" href="{{ url('/landing/products-filter') }}">Products</a></li>
            <li class="nav-item" data-nav-item="data-nav-item"><a id="whishlist" class="nav-link" href="{{ url('/landing/wishlist') }}">Wishlist</a></li>
            <li class="nav-item" data-nav-item="data-nav-item"><a id="shipinfo" class="nav-link" href="{{ url('/landing/shipping-info') }}">Shipping Info</a></li>
            {{-- <li class="nav-item" data-nav-item="data-nav-item"><a id="vendor" class="nav-link" href="{{ url('/admin/add-product') }}">Be a vendor</a></li> --}}
            <li class="nav-item" data-nav-item="data-nav-item"><a id="trackorder" class="nav-link" href="{{ url('/landing/order-tracking') }}">Track order</a></li>
            <li class="nav-item" data-nav-item="data-nav-item"><a id="checkout" class="nav-link pe-0" href="{{ url('/landing/checkout') }}">Checkout</a></li>
